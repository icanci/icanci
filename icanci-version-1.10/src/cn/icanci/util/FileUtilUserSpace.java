...
public class FileUtilUserSpace {
	// 可以接收的图片类型
		...
		try {
			...
			for (FileItem fileItem : items) {
				...
				if (fileItem.isFormField()) {
					...
					String dir = req.getServletContext().getRealPath("/spaceImagesUploadedByUsers");
					...
					System.out.println("/spaceImagesUploadedByUsers/" + uuidName);
					map.put(fileName, "/spaceImagesUploadedByUsers/" + uuidName);
				}
			}
