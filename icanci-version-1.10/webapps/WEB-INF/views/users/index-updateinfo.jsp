...
<!DOCTYPE html>
<html>
	<!-- 登陆之后先跳转到 servlet 判断是否有头像 如果没有就跳转到这里
			有就直接登陆
	 -->

	<head>
		<meta charset="utf-8">
		<title>小璨小璨,完善信息</title>
		...
		<link rel="stylesheet" type="text/css" href="/viewOfUsers/css/index-updateinfo.css" />
